...
> **[RELASI] KONFLIK PARSIAL** — Varian untuk model GPT/Codex: randomisasi layout via Python, GSAP-heavy. Di ekosistem kita (GLM), pakai hanya bagian prinsipnya. Aturan kita menang bila bentrok.
