...
> **[TASTE]** Skill dari [Leonxlnx/taste-skill](https://github.com/Leonxlnx/taste-skill) (MIT). Catatan integrasi lengkap: `skills/_TASTE-SKILLS-INTEGRASI.md`.
> **[RELASI] KONFLIK PARSIAL** — Inti taste-skill v2 (86 KB). Memuat ban absolut (serif Fraunces/Instrument Serif, Inter default) yang BERTENTANGAN dengan prd-builder kita. Gunakan untuk tekniknya (dial, hero discipline, ban list), tapi aturan kita menang bila bentrok.
> **[ATURAN]** Bila aturan skill ini bertentangan dengan `antislop*`, `prd-builder`, atau `AGENTS.md` kita: **aturan kita menang**, kecuali user eksplisit meminta arah taste-skill.
