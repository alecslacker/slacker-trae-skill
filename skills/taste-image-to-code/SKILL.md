...
> **[RELASI] KOMPLEMEN** — Pipeline: generate gambar acuan → analisis → implementasi. Selaras dengan Phase 4 prd-builder kita. Untuk generate gambar WAJIB pakai byteplus-seedream5, bukan tool bawaan skill ini.
